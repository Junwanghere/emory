...
const endDate = computed(() => {
  return dayjs(`${selectedYear.value}-${selectedMonth.value}`).endOf('month').format('YYYY-MM-DD')
})
...
<template>
  <div class="p-5 bg-blue-50 h-dvh">
    ...
    <LineChart class="mb-5" :startDate="startDate" :endDate="endDate" :monthlyData="monthlyData" />
